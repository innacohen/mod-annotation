...
#define ko _p[5]
#define ko_columnindex 5
#define ek1 _p[6]
#define ek1_columnindex 6
#define ek _p[7]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 ka /gpfs/gibbs/project/mcdougal/imc33/mod-extract/code/ka.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double FARADAY = 96485.3399;
 static double R = 8.31447215;
static int _reset;
static char *modelname = "the transient, outward potassium current";
...
static int  settables ( _threadargsprotocomma_ double _lv ) {
   m_inf = pow( ( .0761 * exp ( ( _lv + 94.22 ) / 31.84 ) / ( 1.0 + exp ( ( _lv + 1.17 ) / 28.93 ) ) ) , ( .3333 ) ) ;
   tau_m = ( .3632 + 1.158 / ( 1.0 + exp ( ( _lv + 55.96 ) / 20.12 ) ) ) / qt ;
   h_inf = 1.0 / pow( ( 1.0 + exp ( ( _lv + 53.3 ) / 14.54 ) ) , 4.0 ) ;
   tau_h = ( 1.24 + 2.678 / ( 1.0 + exp ( ( _lv + 50.0 ) / 16.027 ) ) ) / qt ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/gpfs/gibbs/project/mcdougal/imc33/mod-extract/code/ka.mod";
static const char* nmodl_file_text = 
