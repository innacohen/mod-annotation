...
plot_arrow(df)
plot_db(df, order_by = "sens_xgb", facet_by_family = FALSE)
plot_db(df, order_by = "abs_delta", facet_by_family = TRUE)
plot_db(df, order_by = "abs_delta", facet_by_family = TRUE, labels = "minimal")
plot_db(df, style = "winner", order_by = "abs_delta", facet_by_family = TRUE, labels = "minimal")
