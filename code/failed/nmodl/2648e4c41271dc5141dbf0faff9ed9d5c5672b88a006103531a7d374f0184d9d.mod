...
PARAMETER {
	...
	tau_d = 75 (ms)			:320  (ms) Chapman DE 2003, Fig 2B Ventromedial - decay tau
	tau_d_slow = 75 (ms) :
	amptau2 = 1.0
	...
	qfact = 1			: convert to 35 degC - Gutfreund, Table 7.1
...
ASSIGNED {
	...
	y_slow_add (/ms)    : value added to y1 when a presynaptic spike is registered
	y_slow_loc (/ms)
...
STATE { 
	y1 (/ms) 
	y2 
	y_slow 	: sum of beta-functions, describing the total conductance
}
